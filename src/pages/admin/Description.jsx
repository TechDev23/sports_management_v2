...
function description() {
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
      <img className="object-cover object-center rounded" alt="hero" src="images/cricket.jpg.jpg"/>
      
    </div>
    <div className="p-4 xl:w-1/2 md:w-1/3 w-full ml-16 mb-5">
        <div className="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
          <h2 className="text-sm tracking-widest title-font mb-1 font-medium">TOURNAMENT</h2>
          <h1 className="text-5xl text-gray-900 pb-4 mb-4 border-b border-gray-200 leading-none">SUMMARY</h1>
          ...
          <button className="flex items-center mt-auto text-white bg-orange-500 border-0 py-2 px-4 w-full focus:outline-none hover:bg-gray-500 rounded" onClick={()=> navigate("/apply")}>Register
    ...
    <div className="ml-8">
        ...
        <p className='font-bold text-black-400 text-2xl pt-4 pr-4 border-l-4 pl-4 border-orange-500'><strong>Team Registration: </strong> Teams interested in participating in the tournament register themselves by providing necessary information such as team name, contact details, and player details.</p>
        <p className='font-bold text-black-400 text-2xl pt-4 pr-4 border-l-4 pl-4 border-orange-500'><strong>Fixtures and Schedule:  </strong> The tournament organizers create a fixture or schedule that determines the dates, venues, and match-ups for each team throughout the tournament. This schedule is usually shared with the participating teams and made available to the public.</p>
