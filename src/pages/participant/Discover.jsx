      ...
      <div className="bg-white w-full h-screen drop-shadow-2xl rounded-md">
        <div className="  p-4">
          <div className="border-b-2 w-full">
            <p className="bg-gray-100 p-2 px-4 w-fit rounded-xl mt-2 mb-2 text-blue-gray-900 font-bold text-3xl">
              Tournaments
            </p>
          </div>
                  ...
                  <CardBody className="space-y-3 w-auto">
                    <div className="flex flex-row justify-between">
                      <Typography
                        variant="h5"
                        color="blue-gray"
                        className="mb-2 bg-gray-100 rounded-2xl p-1 px-2"
                      >
                        {tour.name}
                      </Typography>
                      {tour.isActive ? (
                        <Typography
                          variant="h5"
                          color="green"
                          className="mb-2 bg-green-50 py-1 px-2  rounded-2xl w-fit"
                        >
                          Active
                        </Typography>
                      ) : (
                        <Typography
                          variant="h5"
                          color="red"
                          className="mb-2 bg-red-50 py-1 px-3  rounded-2xl w-fit"
                        >
                          Ended
                        </Typography>
                      )}
                    ...
                    <div className="text-sm flex flex-row justify-between font-normal items-center">
                      <Typography>{tour.start_date.split("T")[0]}</Typography>
                      <p className="font-bold text-blue-gray-900">
                        ---- to ----
                      </p>
                      <Typography>{tour.end_date.split("T")[0]}</Typography>
                    </div>

                    <div className="flex flex-col border-y py-1">
                      <div className="flex justify-between items-center">
                        <p className="text-sm font-bold text-blue-gray-900 px-1 rounded-2xl bg-gray-100 w-fit">
                          details
                        </p>
                        <p className="text-sm font-bold px-1 rounded-2xl  w-fit text-blue-gray-900 bg-gray-100">
                          Max team size : {tour.team_size}
                        </p>
                      </div>
