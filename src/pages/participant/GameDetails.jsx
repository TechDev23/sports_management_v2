  ...
  <div className="container mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
    ...
    <div className="p-4 xl:w-1/2 md:w-1/3 w-full ml-16">
        <div className="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
          ...
          <button className="flex items-center mt-auto text-white bg-orange-500 border-0 py-2 px-4 w-full focus:outline-none hover:bg-gray-500 rounded" onClick={()=> navigate("/participant/apply")}>Register
