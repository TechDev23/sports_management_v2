...
export const fetchTournamentsAPI = async (requestData) => {
  try {
    ...
    const response = await axios.get(
      `/tournament/?isActive=${requestData.isActive}`
    );
...
export const getTournamentEntriesAPI = async (reqData) => {
  try {
    const res = await axios.get(
      `/tournament/${reqData.id}/entries?isApproved=${reqData.isApproved}`
    );
    return res.data;
  } catch (error) {
    console.log("Error while call get tournament by id", error);
...
export const postMatchResultAPI = async (reqData) => {
  try {
    const res = await axios.post(
      `/tournament/${reqData.id}/match/${reqData.match_id}?winner_id=${reqData.winner_id}`,
      { winner_id: reqData.winner_id }
    );
    return res.data;
  } catch (error) {
...
export const getMatchScoreAPI = async (reqData) => {
  try {
    const res = await axios.get(
      `/tournament/${reqData.id}/match/${reqData.match_id}/score`
    );
    return res.data;
  } catch (error) {
